...
public class ConvertTypes {
     ...
     * @return String[]
     */
    public static String[] Convert(edu.mit.ilab.rest.ArrayOfString arrayOfString) {
        String[] strings = null;

        if (arrayOfString != null) {
            strings = arrayOfString.getStringList().toArray(new String[0]);
        }
     ...
     */
    public static ClientSubmissionReport Convert(edu.mit.ilab.rest.ClientSubmissionReport proxyClientSubmissionReport) {
     ...
     */
    public static ExperimentStatus Convert(edu.mit.ilab.rest.ExperimentStatus proxyExperimentStatus) {
     ...
     */
    public static LabExperimentStatus Convert(edu.mit.ilab.rest.LabExperimentStatus proxyLabExperimentStatus) {
     ...
     * @return LabStatus
     */
    public static LabStatus Convert(edu.mit.ilab.rest.LabStatus proxyLabStatus) {
     ...
     * @return ResultReport
     */
    public static ResultReport Convert(edu.mit.ilab.rest.ResultReport proxyResultReport) {
     ...
     */
    public static ValidationReport Convert(edu.mit.ilab.rest.ValidationReport proxyValidationReport) {
     ...
     * @return WaitEstimate
     */
    public static WaitEstimate Convert(edu.mit.ilab.rest.WaitEstimate proxyWaitEstimate) {
