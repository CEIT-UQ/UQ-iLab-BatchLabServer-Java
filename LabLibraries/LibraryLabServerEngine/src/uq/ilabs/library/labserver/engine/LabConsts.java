...
public class LabConsts {
    ...
    public static final String STRPRM_XmlLabConfigurationPath = "XmlLabConfigurationPath";
    /*
    ...
    public static final String STRXML_SbName = "sbName";
    ...
    public static final String STRXML_SetupId_EquipmentGeneric = "EquipmentGeneric";
    /*
