...
public class ConvertTypes {
     ...
     * @return String[]
     */
    public static String[] Convert(uq.ilabs.labserver.ArrayOfString arrayOfString) {
        String[] strings = null;
     ...
     */
    public static ExperimentStatus Convert(uq.ilabs.labserver.ExperimentStatus proxyExperimentStatus) {
     ...
     */
    public static LabExperimentStatus Convert(uq.ilabs.labserver.LabExperimentStatus proxyLabExperimentStatus) {
     ...
     * @return LabStatus
     */
    public static LabStatus Convert(uq.ilabs.labserver.LabStatus proxyLabStatus) {
     ...
     * @return ResultReport
     */
    public static ResultReport Convert(uq.ilabs.labserver.ResultReport proxyResultReport) {
     ...
     */
    public static SubmissionReport Convert(uq.ilabs.labserver.SubmissionReport proxySubmissionReport) {
     ...
     */
    public static ValidationReport Convert(uq.ilabs.labserver.ValidationReport proxyValidationReport) {
     ...
     * @return WaitEstimate
     */
    public static WaitEstimate Convert(uq.ilabs.labserver.WaitEstimate proxyWaitEstimate) {
