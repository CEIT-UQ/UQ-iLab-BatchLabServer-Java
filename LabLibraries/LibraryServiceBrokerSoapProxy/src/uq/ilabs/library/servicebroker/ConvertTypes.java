...
public class ConvertTypes {
     ...
     * @return String[]
     */
    public static String[] Convert(edu.mit.ilab.servicebroker.proxy.ArrayOfString arrayOfString) {
        String[] strings = null;
     ...
     */
    public static ClientSubmissionReport Convert(edu.mit.ilab.servicebroker.proxy.ClientSubmissionReport proxyClientSubmissionReport) {
     ...
     */
    public static ExperimentStatus Convert(edu.mit.ilab.servicebroker.proxy.ExperimentStatus proxyExperimentStatus) {
     ...
     */
    public static LabExperimentStatus Convert(edu.mit.ilab.servicebroker.proxy.LabExperimentStatus proxyLabExperimentStatus) {
     ...
     * @return LabStatus
     */
    public static LabStatus Convert(edu.mit.ilab.servicebroker.proxy.LabStatus proxyLabStatus) {
     ...
     * @return ResultReport
     */
    public static ResultReport Convert(edu.mit.ilab.servicebroker.proxy.ResultReport proxyResultReport) {
     ...
     */
    public static ValidationReport Convert(edu.mit.ilab.servicebroker.proxy.ValidationReport proxyValidationReport) {
     ...
     * @return WaitEstimate
     */
    public static WaitEstimate Convert(edu.mit.ilab.servicebroker.proxy.WaitEstimate proxyWaitEstimate) {
