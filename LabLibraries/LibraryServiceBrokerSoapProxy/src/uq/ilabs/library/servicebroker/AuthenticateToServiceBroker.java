...
//                System.out.println(AuthenticateToServiceBroker.class.getSimpleName());
//                System.out.println(outputStream.toString());
    ...
    private void ProcessSoapHeader(SOAPMessageContext messageContext) throws SOAPException {
        ...
        if (object != null && object instanceof SbAuthHeader) {
             ...
             * SbAuthHeader
             */
            this.ProcessSbAuthHeader((SbAuthHeader) object, QnameFactory.getSbAuthHeaderQName(), soapHeader);
        }
    }
