...
public class ServiceBrokersBean implements Serializable {
    ...
    public void setSelectedName(String selectedName) {
        ...
        if (selectedName == null || selectedName.equals("") == true) {
            actionNew();
        } else {
    ...
    public String actionNew() {
        ...
        this.holMessage.setRendered(false);
    ...
    private void ShowMessageInfo(String message) {
        this.holMessage.setStyleClass(Consts.STRSTL_InfoMessage);
        this.holMessage.setValue(message);
        this.holMessage.setRendered(true);
    }

    private void ShowMessageError(String message) {
        this.holMessage.setStyleClass(Consts.STRSTL_ErrorMessage);
        this.holMessage.setValue(message);
        this.holMessage.setRendered(true);
    }
}
