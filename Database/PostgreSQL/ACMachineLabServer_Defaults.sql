 ...
 */
SELECT LabServer_Add ('ACMachine Java','2CD01113C51C4ca997B059531CD9469D','http://localhost:8080/ACMachineLabServer/LabServerWebService', 'you@your.email', NULL, NULL, TRUE);
